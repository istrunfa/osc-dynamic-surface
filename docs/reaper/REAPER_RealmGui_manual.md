# RealmGui Examples Knowledge Base

This document contains real Lua examples demonstrating usage of RealmGui (ReaImGui) for building GUIs in REAPER scripts. It includes:

- ImGui function calls
- GUI layout logic
- Upgrade logic between versions
- Abstractions between gfx and ImGui
